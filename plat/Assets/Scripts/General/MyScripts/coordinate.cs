...
namespace Toon.Extend
{
    public static class Coordinate
    {
        public static void setp(this Transform t, double? x = null, double? y = null, double? z = null)
        {
            ...
            if (x is null && y is null && z is null) throw new NanmoHaittehenwaException();
            t.position = new(
                x is null ? t.position.x : x.Single(), y is null ? t.position.y : y.Single(), z is null ? t.position.z : z.Single());
        }
        ...
        public static void setpc22(this Transform t,
            float? minX = null, float? maxX = null, float? minY = null, float? maxY = null, float? minZ = null, float? maxZ = null)
        {
            ...
            t.position = new Vector3(
                minX is null ? t.position.x : Mathf.Clamp(t.position.x, minX.Single(), maxX.Single()),
        ...
        {
            if (minX is null && maxX is null && minY is null && maxY is null) throw new NanmoHaittehenwaException();
            t.position = new(Mathf.Clamp(t.position.x, minX.Single(), maxX.Single()),
                Mathf.Clamp(t.position.y, minY.Single(), maxY.Single()));
        }
        public static void setpc2(this Transform t, float? x = null, float? y = null)
        {
            if (x is null && y is null) throw new NanmoHaittehenwaException();
        ...
        public static void setr(this Transform t, double? x = null, double? y = null, double? z = null)
        {
            ...
            t.rotation = Quaternion.Euler(
                x is null ? t.localScale.x : x.Single(),
                y is null ? t.localScale.y : y.Single(),
                z is null ? t.localScale.z : z.Single()
            );
        }
